...
class Gift(models.Model):
    ...
    clothes_to_use = models.IntegerField(null=True, default=0)
    clothes_useless = models.IntegerField(null=True, default=0)
    toys = models.IntegerField(null=True, default=0)
